    ...
    def validate_batch_iter(
        ...
        with attach_pipeline_state_to_model(model=model, pipeline_state=state):
            ...
            for micro_batch in batch:
                ...
                output = self.forward(context=context, state=state, micro_batch=micro_batch, model=model, is_validation=True)
                ...
                output['domain_idx'] = micro_batch['input_domain'].flatten().tolist()
